...
public class SG02GoogleTest implements SG02Test {

    private GeoRef geoRef;

    public SG02GoogleTest() {
    }

    @Before
    public void setUp() {
        geoRef = GeoRefFactory.createGeoRefGoogle();
    }
    ...
    public void ensureCorrectCity() {
        ...
        location = geoRef.enrichPostalLocation("4580-594 Cristelo");
        Assert.assertEquals(expectedCity, location.getCity());
    }
